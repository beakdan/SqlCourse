...
DECLARE @JSonData AS NVARCHAR(MAX) = N'{"SalesOrderID":43659,"OrderDate":"2011-05-31T00:00:00","money":{"SubTotal":20565.6206,"TaxAmt":1971.5149,"Freight":616.0984,"TotalDue":23153.2339},"Person":[{"FirstName":"James","LastName":"Hendergart","Email":[{"Address":"james9@adventure-works.com","ModifiedDate":"2011-05-31T00:00:00"}]}]}';
SELECT	*
FROM	OPENJSON(@JSonData)
WITH(
	SalesOrderID	INTEGER		'$.SalesOrderID',
...
--OPENXML
--xmltype.nodes()
--{"SalesOrderID":43659,"OrderDate":"2011-05-31T00:00:00","money":{"SubTotal":20565.6206,"TaxAmt":1971.5149,"Freight":616.0984,"TotalDue":23153.2339},"Person":[{"FirstName":"James","LastName":"Hendergart","Email":[{"Address":"james9@adventure-works.com","ModifiedDate":"2011-05-31T00:00:00"}]}]}